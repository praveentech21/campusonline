...
CREATE TABLE `recharges` (
  ...
  `recharge_id` varchar(50) DEFAULT 'initiate',
...
INSERT INTO `recharges` (`order_id`, `status`, `recharge_id`, `signature`, `student_id`, `available_recharge`, `amount`, `cashback`, `total_recharge`, `date`) VALUES
('1', 0, 'pay_NjyqnZ', '', '21B91A6206', 12.05, 2, 0.1, 14.15, '2024-03-08'),
('2', 0, 'pay_NjyQsT', '', '21B91A6206', 10, 1, 0.05, 11.05, '2024-03-08'),
('3', 0, 'pay_NjyTcg', '', '21B91A6206', 11, 1, 0.05, 12.05, '2024-03-08'),
('4', 0, 'pay_NkFGIP', '', '21B91A6206', 14.15, 1, 0.05, 15.2, '2024-03-09'),
('5', 0, 'pay_NkFSfp', '', '21B91A6206', 15.2, 1, 0.05, 16.25, '2024-03-09'),
('6', 0, 'pay_NkIfdJ', '', '21B91A6206', 19.4, 1, 0.05, 20.45, '2024-03-09'),
('7', 0, 'pay_NkIS6g', '', '21B91A6206', 16.25, 1, 0.05, 17.3, '2024-03-09'),
('8', 0, 'pay_NkIUcD', '', '21B91A6206', 17.3, 1, 0.05, 18.35, '2024-03-09'),
('9', 0, 'pay_NkIWbU', '', '21B91A6206', 18.35, 1, 0.05, 19.4, '2024-03-09'),
('order_Nl8F2CuLr13o6J', 0, 'initiate', '', '21B91A6206', 20.45, 1, 0.05, 21.5, '2024-03-11'),
('order_Nl8F58aAM3MeT0', 0, 'initiate', '', '21B91A6206', 20.45, 1, 0.05, 21.5, '2024-03-11'),
('order_Nl8KthLz3eVQBT', 0, 'initiate', '', '21B91A6206', 20.45, 1, 0.05, 21.5, '2024-03-11'),
('order_Nl8mGo9a8KsC8v', 0, 'initiate', '', '21B91A6206', 20.45, 110, 5.5, 135.95, '2024-03-11'),
('order_Nl8TlqBrBnnFGE', 0, 'initiate', '', '21B91A6206', 20.45, 1, 0.05, 21.5, '2024-03-11'),
('order_Nl8UtZESZ1adIX', 0, 'initiate', '', '21B91A6206', 20.45, 1, 0.05, 21.5, '2024-03-11');
...
('Ravi Kumar Satya Sai Praveen', '21B91A6206', '9052727402', '2025', 'CSD', 'A', 'Trimurthulu', 'Ganga Tulasi', 'Tholeru', 'Room', '21B91A6206_saipraveen-pic.jpeg', '123123', 'ravikumar_csd@srkrec.edu.in', 20.45, 4802);
