<?php
    ...
    if(isset($_GET['product_id'])){
        ...
        if($removefromcart){
            ...
            echo "<script> alert('Product removed from cart successfully'); window.location.href = 'index.php'; </script>";
            }
            else{
                echo "<script> alert('Product removed from cart successfully'); window.location.href = 'index.php'; </script>";
            }
            ...
            echo "<script> alert('Product not removed from cart'); window.location.href = 'index.php'; </script>";  
        }
    }
?>