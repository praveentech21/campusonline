      ...
      <!-- Sidebar Ends Here Shiva -->
        ...
        <!-- Content Starts Here Shiva-->
          <div class="container-xxl flex-grow-1 container-p-y">
            ...
            <div class="col-md-6">
                  <div class="card mb-4">
                    <h5 class="card-header">Enter the offer header</h5>
                    <form action="#" method="post">
                      <div class="card-body">
                        <div>
                          <label for="defaultFormControlInput" class="form-label">Header statment</label>
                          <input type="text"
                            class="form-control"
                            id="defaultFormControlInput"
                            placeholder="Use the statment like 'Get 50% off on all products'"
